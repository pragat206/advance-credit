...
from src.shared.models import AdminUser, Banner, Product, Partner, FAQ, Testimonial, Service, TeamMember
print('DEBUG: Imported models')
from src.main_app.routes.admin.auth import set_admin_session, clear_admin_session, is_admin_authenticated
...
BANNERS_DIR = "src/main_app/static/banners/"
os.makedirs(BANNERS_DIR, exist_ok=True)

PARTNERS_DIR = "src/main_app/static/partners/"
